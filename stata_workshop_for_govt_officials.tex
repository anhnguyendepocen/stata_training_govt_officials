...
\begin{stlog}\input{stata_workshop_for_govt_officials_28.log.tex}\end{stlog}
			\vspace{1mm}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_32.log.tex}\end{stlog}
		\end{enumerate}
	\end{frame}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_36.log.tex}\end{stlog}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_38.log.tex}\end{stlog}
		\vspace{2mm}
