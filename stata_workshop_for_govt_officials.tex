...
\begin{stlog}\input{stata_workshop_for_govt_officials_19.log.tex}\end{stlog}
			\vspace{1mm}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_21.log.tex}\end{stlog}
\begin{center}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_29.log.tex}\end{stlog}
			\vspace{1mm}
