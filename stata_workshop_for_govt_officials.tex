...
\begin{stlog}\input{stata_workshop_for_govt_officials_3.log.tex}\end{stlog}
		\begin{itemize}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_4.log.tex}\end{stlog}
	...
	\begin{frame}
		...
		\end{itemize}
\begin{stlog}\input{stata_workshop_for_govt_officials_5.log.tex}\end{stlog}
	\end{frame}
	...
	\begin{frame}
		...
		\end{itemize}
\begin{stlog}\input{stata_workshop_for_govt_officials_6.log.tex}\end{stlog}
		\begin{itemize}
	...
	\begin{frame}
		...
		\end{itemize}
\begin{stlog}\input{stata_workshop_for_govt_officials_7.log.tex}\end{stlog}
		\begin{itemize}
		\onslide<3->	\item Now let's replace that with 1 when it satisfies the condition that the two variables are equal. Type:
		\end{itemize}
\begin{stlog}\input{stata_workshop_for_govt_officials_8.log.tex}\end{stlog}
		\begin{itemize}
	...
	\begin{frame}
		...
		\end{itemize}
\begin{stlog}\input{stata_workshop_for_govt_officials_9.log.tex}\end{stlog}
	...
	\begin{frame}
		...
		\end{itemize}
\begin{stlog}\input{stata_workshop_for_govt_officials_10.log.tex}\end{stlog}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_11.log.tex}\end{stlog}
		...
		\end{itemize}
\begin{stlog}\input{stata_workshop_for_govt_officials_12.log.tex}\end{stlog}
	\end{frame}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_13.log.tex}\end{stlog}
	\end{frame}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_14.log.tex}\end{stlog}
			to
...
\begin{stlog}\input{stata_workshop_for_govt_officials_16.log.tex}\end{stlog}
	...
	\begin{frame}
		...
		\onslide<1-> Now, let's save the modified data as a excel. 
					 ...
					 Type...
		\vspace{2mm}
\begin{stlog}\input{stata_workshop_for_govt_officials_17.log.tex}\end{stlog}
		\vspace{2mm}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_20.log.tex}\end{stlog}
			\vspace{1mm}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_26.log.tex}\end{stlog}
			\vspace{1mm}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_27.log.tex}\end{stlog}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_33.log.tex}\end{stlog}
	\end{frame}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_35.log.tex}\end{stlog}
			\vspace{1mm}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_37.log.tex}\end{stlog}
			\vspace{1mm}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_39.log.tex}\end{stlog}
	\end{frame}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_41.log.tex}\end{stlog}
	\end{frame}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_42.log.tex}\end{stlog}
...
\end{center}
	...
	\frametitle{\textsc{More on effective visualization}}
	The box graph:
\begin{stlog}\input{stata_workshop_for_govt_officials_44.log.tex}\end{stlog}
	\end{frame}	

	\begin{frame}
	\frametitle{\textsc{More on effective visualization}}
	The histogram graph:
\begin{stlog}\input{stata_workshop_for_govt_officials_45.log.tex}\end{stlog}
	\end{frame}	

	\begin{frame}
	\frametitle{\textsc{More on effective visualization}}
	The bar graph:
\begin{stlog}\input{stata_workshop_for_govt_officials_46.log.tex}\end{stlog}
	\end{frame}	

	\begin{frame}
	\frametitle{\textsc{More on effective visualization}}
	The scatter and lfit graph:
\begin{stlog}\input{stata_workshop_for_govt_officials_47.log.tex}\end{stlog}
	\end{frame}	

	\begin{frame}
	\frametitle{\textsc{More on effective visualization}}
	Finally, you must make some adjustments to the combining command.
\begin{stlog}\input{stata_workshop_for_govt_officials_48.log.tex}\end{stlog}
	\end{frame}	
...
\begin{stlog}\input{stata_workshop_for_govt_officials_49.log.tex}\end{stlog}
	...
	\begin{frame}
		...
		\end{itemize}
\begin{stlog}\input{stata_workshop_for_govt_officials_50.log.tex}\end{stlog}
	\end{frame}
		\begin{frame}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_51.log.tex}\end{stlog}
		...
		\onslide<3-> 
\begin{stlog}\input{stata_workshop_for_govt_officials_52.log.tex}\end{stlog}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_53.log.tex}\end{stlog}
			\vspace{2mm}
			\item You can add multiple variable at a time.
\begin{stlog}\input{stata_workshop_for_govt_officials_54.log.tex}\end{stlog}
		\end{itemize}
	\end{frame}
...
\begin{stlog}\input{stata_workshop_for_govt_officials_55.log.tex}\end{stlog}
		\end{itemize}
	\end{frame}
